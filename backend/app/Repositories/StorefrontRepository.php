...
class StorefrontRepository implements StorefrontRepositoryInterface
{
    public function resolveActiveStore(): ?object
    {
        $store = DB::table('store_settings')
            ->select(['id', 'store_name', 'layout', 'logo_url', 'favicon_url', 'tagline', 'banner_image', 'banner_title', 'banner_text', 'currency', 'shipping_charge', 'free_shipping_threshold', 'is_active'])

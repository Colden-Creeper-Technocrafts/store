...
<body>
  <div class="card">
    ...
    <p>Thank you for your order. Click the button below to verify your email address.</p>
    <a href="{{ $verifyUrl }}" class="btn">Verify Email</a>
    <p class="note">If you did not place this order, you can safely ignore this email.</p>
  </div>
</body>
</html>
